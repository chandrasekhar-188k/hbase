...
public class TestRegionFavoredNodesWhenCompactOffload extends TestRegionFavoredNodes {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    TEST_UTIL.startMiniCluster(
      StartTestingClusterOption.builder().build().builder().numCompactionServers(1)
    ...
    table = TEST_UTIL.createTable(tableDescriptor, Bytes.toByteArrays(COLUMN_FAMILY),
      HBaseTestingUtil.KEYS_FOR_HBA_CREATE_TABLE, TEST_UTIL.getConfiguration());
  ...
  public void testFavoredNodes() throws Exception {
    ...
    TEST_UTIL.waitFor(60000, () -> {
      ...
      return hFileCount == HBaseTestingUtil.KEYS_FOR_HBA_CREATE_TABLE.length + 1;
    });
