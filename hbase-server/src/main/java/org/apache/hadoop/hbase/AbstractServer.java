...
public abstract class AbstractServer extends Thread implements Server {
  ...
  /**
   * Utility for constructing an instance of the passed AbstractServer subclass.
   */
  protected static AbstractServer constructServer(final Class<? extends AbstractServer> serverClass,
    final Configuration conf) throws Exception {
    Constructor<? extends AbstractServer> c = serverClass.getConstructor(Configuration.class);
