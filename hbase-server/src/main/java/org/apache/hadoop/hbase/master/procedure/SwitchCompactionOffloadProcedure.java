...
public class SwitchCompactionOffloadProcedure
  ...
  public SwitchCompactionOffloadProcedure(
    CompactionOffloadSwitchStorage compactionOffloadSwitchStorage, boolean CompactionOffloadEnabled,
    ServerName serverName, final ProcedurePrepareLatch syncLatch) {
