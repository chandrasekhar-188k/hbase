...
public class HRegion implements HeapSize, PropagatingConfigurationObserver, Region {
  ...
  /**
   * Get the smallest mvcc readPoint across all the scanners in this region. Writes older than this
   * readPoint, are included in every read operation.
   */
  ...
  public HRegion(final HRegionFileSystem fs, final Configuration confParam,
    ...
    this.minBlockSizeBytes = Arrays.stream(this.htableDescriptor.getColumnFamilies())
