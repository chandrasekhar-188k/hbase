...
public class CompactionOffloadManager {
  ...
  /** Returns CompactionServerMetrics if serverName is known else null */
  ...
  public IsCompactionOffloadEnabledResponse
    ...
    IsCompactionOffloadEnabledResponse response =
      IsCompactionOffloadEnabledResponse.newBuilder().setCompactionOffloadEnabled(enabled).build();
